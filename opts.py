...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 21 16:24:47 2019
...
def get_args():
    ...
    parser.add_argument('--net', default='LSFF',help='fc or attnin or trans，use which net')
    parser.add_argument('--dataset', default='sydney',help='choose dataset,sydney,rsicd,ucm')
    parser.add_argument('--use_num_attr', type=int, default=2,help='')
    ...
    parser.add_argument('--num_layers', type=int, default=1,                   #6 for transformer   
                    help='number of layers in the RNN')
    parser.add_argument('--rnn_size', type=int, default=1000,                   #2048 for transformer 
                    help='size of the rnn in number of hidden nodes in each layer')
    parser.add_argument('--grad_clip', type=float, default=0.1, #5.,
                    help='clip gradients at this value')
    parser.add_argument('--SEED', 
                        default=123, type=int, help='seed')
    ...
    parser.add_argument('--RAdam',default=True,help="")
